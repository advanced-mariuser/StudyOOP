...
TEST_CASE("Make car and check speed, gear, engine")
{
    Car car;
...
TEST_CASE("Turn on engine several time")
{
    Car car;
...
TEST_CASE("Turn off engine several time")
{
    Car car;
...
TEST_CASE("Work with car when engine is off")
{
    Car car;
...
TEST_CASE("After turn on engine car is standing still")
{
    Car car;
...
TEST_CASE("Neutral gear do not give pick up speed")
{
    Car car;
...
TEST_CASE("if speed = 0 and turn on neutral")
{
    Car car;
...
TEST_CASE("Reverse gear don't turn on if speed != 0")
{
    Car car;
...
TEST_CASE("Reverse gear engages after neutral when speed = 0")
{
    Car car;
...
TEST_CASE("switch from reverse to forward gear only at zero speed")
{
    Car car;
...
TEST_CASE("Switched to neutral gear in reverse at when speed != 0, switch to forward gear only after stopping")
{
    Car car;
...
TEST_CASE("Can shift from any gear to any, provided that the current speed of the car is within the speed range")
{
    Car car;
...
TEST_CASE("The engine can only be turned off at zero speed in neutral")
{
    Car car;
...
TEST_CASE("Test set gear -1 -> set speed in range 1 gear -> 1 -> 2")
{
    Car car;
...
TEST_CASE("Check range speed of gear -1")
{
    Car car;
...
TEST_CASE("Check range speed of gear 2")
{
    Car car;
...
TEST_CASE("Check range speed of gear 3")
{
    Car car;
...
TEST_CASE("Check range speed of gear 4")
{
    Car car;
...
TEST_CASE("Check range speed of gear 5")
{
    Car car;
